...
def windPowerGraphs(stateSeries):
    ...
    pyoff.plot(fig, filename='windSeries.html', auto_open=False )
...
def windTemperatureHeatMap(stateSeries):
    ...
    fig = go.Figure(data=data, layout=layout)
    pyoff.plot(fig, filename='temp-wind-heatmap.html', auto_open=False)
...
def lossesGraph(stateSeries):
    ...
    fig = go.Figure(data=data, layout=layout)
    pyoff.plot(fig, filename='lossesGraph.html', auto_open=False)
...
def graphTransformer(stateSeries):
    ...
    pyoff.plot(fig, filename='trafoTempsGraph.html', auto_open=False)
...
def graphConverter(stateSeries):
    ...
    pyoff.plot(fig, filename='converterTempsGraph.html', auto_open=False)
...
def graphGenerator(stateSeries):
    ...
    pyoff.plot(fig, filename='generatorTempsGraph.html', auto_open=False)
